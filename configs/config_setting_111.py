...
class setting_111_21ele_in21_out1_split8_x8:
    """
    the config of training setting.
    input:ALl elements except geo
    ...
    model_config = {
        ...
        'weight_reg': 0.8,
        'weight_wavelet': 0.4,
        'dic_atten': {'MSCB': True, 'CBAM': True},
        'dic_ssd': {'bidirection': False, 'ssd_positve_dA': True},
        'dic_geo_lsm': {'geo_lsm': False}
    }
    if model_config['dic_atten']['MSCB']:
        mscb = 1
    else:
        mscb = 0

    if model_config['dic_atten']['CBAM']:
        cbam = 1
    else:
        cbam = 0
    ...
    if opt == 'Adadelta':
        ...
        lr = 2e-4  # default: 1e-3 – learning rate
        betas = (0.9,
        ...
        weight_decay = 0  # default: 0 – weight decay (L2 penalty) 0.0001
        ...
        lr = 1e-3  # default: 1e-3 – learning rate
        betas = (0.9,
                 0.999)  # default: (0.9, 0.999) – coefficients used for computing running averages of gradient and its square
        eps = 1e-8  # default: 1e-8 – term added to the denominator to improve numerical stability
    ...
    if sch == 'StepLR':
        ...
        milestones = [60, 120, 180, 240, 300, 360, 420]  # – List of epoch indices. Must be increasing.
        gamma = 0.5  # – Multiplicative factor of learning rate decay. Default: 0.1.
        last_epoch = -1  # – The index of last epoch. Default: -1.
        ...
        warm_up_epochs = 10
        T_max = epochs-warm_up_epochs  # – Maximum number of iterations. Cosine function period.
        eta_min = 0.000001  # – Minimum learning rate. Default: 0.
        last_epoch = -1  # – The index of last epoch. Default: -1.
